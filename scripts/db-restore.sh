...
if [ -z "$BACKUP_FILE" ]; then
  echo "Usage: ./scripts/db-restore.sh [--local|--remote] <backup_file>"
  echo ""
  echo "Examples:"
...
echo "   Target: $TARGET"
echo ""
echo "⚠️  WARNING: This will DROP ALL TABLES on $TARGET and replace with backup data."
...
# Import schema first (with PRAGMA foreign_keys=OFF)
